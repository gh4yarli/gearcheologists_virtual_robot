...
/**
 * For internal use only. Base class for a physics-based robot with four mecanum wheels to help test Pinpoint
 */
public abstract class MecanumPinpointBase extends VirtualBot {
     ...
     */
    public MecanumPinpointBase() {
        super();
        MOTOR_TYPE = MotorType.Neverest40;
    }

    public MecanumPinpointBase(MotorType driveMotorType){
        super();
