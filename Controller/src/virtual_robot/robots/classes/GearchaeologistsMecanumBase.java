 ...
 *
 * GearchaeologistsMecanumBase is the controller class for the "mecanum_bot.fxml" markup file.
 *
 */
@BotConfig(name = "Gearchaeologists Mecanum Bot", filename = "gearchaeologists_mecanum_bot")
public class GearchaeologistsMecanumBase extends MecanumPinpointBase {
    ...
    public GearchaeologistsMecanumBase(){
        super();
    }
